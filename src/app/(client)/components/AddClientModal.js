          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                <input
                  {...register("contact")}
                  className={`w-full border p-2 rounded placeholder-gray-500 ${errors.contact ? "border-red-500" : ""
                    }`}
              ...
              <div>
                <input
                  {...register("company")}
                  className={`w-full border p-2 rounded placeholder-gray-500 ${errors.company ? "border-red-500" : ""
                    }`}
              ...
              <div>
                <input
                  {...register("location")}
                  className={`w-full border p-2 rounded placeholder-gray-500 ${errors.location ? "border-red-500" : ""
                    }`}
              ...
              <div>
                <input
                  type="number"
                  {...register("workers")}
                  className={`w-full border p-2 rounded placeholder-gray-500 ${errors.workers ? "border-red-500" : ""
                    }`}
              ...
              <div>
                <select
                  {...register("machine")}
                  className={`w-full border p-2 rounded text-gray-700 ${errors.machine ? "border-red-500" : ""
                    }`}
                >
              ...
              <div>
                <input
                  ...
                  {...register("date")}
                  className={`w-full border p-2 rounded text-gray-700 placeholder-gray-500 ${errors.date ? "border-red-500" : ""
                    }`}
                />
                {errors.date && (
